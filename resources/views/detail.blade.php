                ...
                @php
                    $label = $attribute == 'dapus'
                        ...
                        : (strpos($attribute, 'bab') === 0
                            ...
                            :  (
                                $attribute == 'pengesahan' ? 'Pengesahan' : (
                                    $attribute == 'abstrak' ? 'Abstrak' : (
                                        $attribute == 'daftarisi' ? 'Daftar Isi' : (
                                            $attribute == 'daftargambar' ? 'Daftar Gambar' : (
                                                $attribute == 'daftarlampiran' ? 'Daftar Lampiran' : (
                                                    $attribute == 'lampiran' ? 'Lampiran' : $attribute
                                                )
                                            )
                                        )
                                    )
