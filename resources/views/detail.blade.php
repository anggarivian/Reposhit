                ...
                @if(auth()->user()->favorites()->where('id_skripsi', $skripsi->id)->exists())
                    <form action="{{ route('removeFavorite1', $skripsi->id) }}" method="POST" style="display:inline;">
                        ...
                        <button type="submit" class="btn btn-danger mr-2">
                            <i class="fas fa-bookmark"></i> <span>Hapus dari Koleksi</span>
                        </button>
                    </form>
                @else
                    <form action="{{ route('addFavorite', $skripsi->id) }}" method="POST" style="display:inline;">
                        ...
                        <button type="submit" class="btn btn-warning mr-2">
                            <i class="fas fa-bookmark"></i> <span>Tambahkan ke Koleksi</span>
                        </button>
                    </form>
                @endif
                                        ...
                                        @foreach($item['replies'] as $reply)
                                            <div class="media mt-3 p-3 border rounded bg-white ml-4 shadow-sm">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    @if(auth()->user() && (auth()->user()->id == $reply->id_user || auth()->user()->role == 'admin'))
