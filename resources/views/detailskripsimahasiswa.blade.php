        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="btn-group">
                        <!-- Tombol Favorite -->
                        <form action="{{ route('toggleFavorite', $skripsi->id) }}" method="POST" style="display:inline;">
                            @csrf
                            <button type="submit" class="btn btn-default" id="btn-favorite">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-heart{{ $skripsi->favorite ? '-fill' : '' }}" viewBox="0 0 16 16">
                                    <path d="M8 2.748-.8 7.567.3 11.473 8 14.5 15.7 11.473 16.8 7.567 8 2.748zM8 14.5a1.5 1.5 0 0 1-1.08-.477L1.5 10.207a.5.5 0 0 1-.08-.136l-1.5-2.6a.5.5 0 0 1 .136-.707L7.293.707a.5.5 0 0 1 .707 0l7.207 7.207a.5.5 0 0 1 .136.707l-1.5 2.6a.5.5 0 0 1-.08.136L9.08 14.023A1.5 1.5 0 0 1 8 14.5z"/>
                                </svg>
                                <span class="ms-1">{{ $skripsi->favorite ? 'Unfavorite' : 'Favorite' }}</span>
                            </button>
                        </form>
                    ...
                    {{-- Form komentar utama --}}
                    <form action="{{ route('postkomentar1') }}" style="margin-top: 8px; display: none;" id="komentar-utama-form" method="POST">
                        @csrf
                        <div class="form-group">
